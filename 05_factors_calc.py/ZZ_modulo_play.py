...
while keep_going == "":
    ...
    lolllies_per_student = num_lollies // num_students
    ...
    print("Each student gets {} lollies".format (lollies_left, lolly_pl))
    print("Yoou have {} {} left".format(lollies_left, lolly_pl))
    print()
